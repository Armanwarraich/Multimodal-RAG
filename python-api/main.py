...
def _debug_log(hypothesis_id: str, location: str, message: str, data: dict):
    ...
    with open(PROJECT_ROOT / "debug-a55e27.log", "a", encoding="utf-8") as f:
...
def _ingest_worker(dest: Path, modality: str, filename: str):
    ...
    try:
        ...
        _debug_log(
            "H10-H13",
            "python-api/main.py:_ingest_worker:start",
            "ingest worker start",
            {
                "filename": filename,
                "modality": modality,
                "python_executable": sys.executable,
                "open_clip_spec": bool(importlib.util.find_spec("open_clip")),
            },
        )
        # #endregion
        ...
        _debug_log(
            "H10-H13",
            "python-api/main.py:_ingest_worker:except",
            "ingest worker exception",
            {
                "filename": filename,
                "modality": modality,
